...
class SignUpScreen extends StatelessWidget {
  ...
  void signUp(BuildContext context) async {
    try {
      ...
      // Séparer les utilisateurs en fonction de leur rôle
      if (_selectedRole == 'Médecin') {
        // Ajouter l'utilisateur à la collection 'medecins'
        await FirebaseFirestore.instance.collection('medecins').doc(userCredential.user?.uid).set({
          'username': _usernameController.text,
          'lastname': _lastnameController.text,
          'email': _emailController.text,
        });
      } else {
        // Ajouter l'utilisateur à la collection 'patients'
